...
#define scf1(a) scanf("%f",&a)      ///single float input
#define scf2(a,b) scanf("%f%f",&a,&b)
#define scf3(a,b,c) scanf("%f%f%f",&a,&b,&c)
#define scd1(a) scanf("%lf",&a)      ///single double input
#define scd2(a,b) scanf("%lf%lf",&a,&b)
#define sc33(a,b,c) scanf("%lf%lf%lf",&a,&b,&c)
...

{
    ...
    while(sci2(a,b),a|b)
    {
        double v,volm,l=(double)(a),f=(double)(b);
        v = sqrt(2*l*f);    ///as d is constant and given d = v^2/2*f ,,, so L = v^2/2*f
        volm = (v*3600)/(2*l);
        printf("%0.8lf %0.8lf\n",v,volm);
    }
